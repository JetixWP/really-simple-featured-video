...
<div class="getpro-content">
	<h1 class="tab-heading"><?php esc_html_e( 'Get Premium Featured Video support with Really Simple Featured Video Pro', 'rsfv' ); ?></h1>
	...
	<h1 class="offer-highlight">Grab the Premium version starting at just <strong>$39.99</strong>.</h1>
